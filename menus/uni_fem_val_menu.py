...
class UNI_FEM_VAL_Menu(tk.Frame):

	def __init__(self, parent, controller):
		tk.Frame.__init__(self, parent)
		self.controller = controller
		self.obj_name = "UNI_FEM_VAL"
		...
		if platform == "darwin":
			...
			button = ttk.Button(self, text="IMP LINE", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-LINE"))
			button.grid(padx=[10,10], column=1, row=7)
			button = ttk.Button(self, text="IMP LINE", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-LINE"))
