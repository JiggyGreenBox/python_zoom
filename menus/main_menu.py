...
class MAIN_Menu(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		if platform == "darwin":
			...
			button = ttk.Button(self, text="HIP", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-HIP"))
			button.grid(padx=[10,10], sticky="W", column=1, row=5)
			button = ttk.Button(self, text="HIP", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-HIP"))
			button.grid(padx=[10,10], sticky="W", column=2, row=5)

			button = ttk.Button(self, text="FEM NECK", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-NECK-AXIS"))
			button.grid(padx=[10,10], sticky="W", column=1, row=6)
			button = ttk.Button(self, text="FEM NECK", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-NECK-AXIS"))
			button.grid(padx=[10,10], sticky="W", column=2, row=6)

			
			

			button = ttk.Button(self, text="FEM U3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-U3"))
			button.grid(padx=[10,10], sticky="W", column=1, row=7)
			button = ttk.Button(self, text="FEM U3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-U3"))
			button.grid(padx=[10,10], sticky="W", column=2, row=7)
			
			button = ttk.Button(self, text="FEM L3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-L3"))
			button.grid(padx=[10,10], sticky="W", column=1, row=8)
			button = ttk.Button(self, text="FEM L3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-L3"))
			...
			button = ttk.Button(self, text="FEM CENTRE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-CENTRE"))
			button.grid(padx=[10,10], sticky="W", column=1, row=9)
			button = ttk.Button(self, text="FEM CENTRE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-CENTRE"))
			button.grid(padx=[10,10], sticky="W", column=2, row=9)

			button = ttk.Button(self, text="TIB CENTRE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-TIB-CENTRE"))
			button.grid(padx=[10,10], sticky="W", column=1, row=10)
			button = ttk.Button(self, text="TIB CENTRE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-TIB-CENTRE"))
			button.grid(padx=[10,10], sticky="W", column=2, row=10)


			button = ttk.Button(self, text="FEM J LINE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-JOINT-LINE"))
			button.grid(padx=[10,10], sticky="W", column=1, row=11)
			button = ttk.Button(self, text="FEM J LINE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-JOINT-LINE"))
			button.grid(padx=[10,10], sticky="W", column=2, row=11)

			button = ttk.Button(self, text="TIB J LINE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-TIB-JOINT-LINE"))
			button.grid(padx=[10,10], sticky="W", column=1, row=12)
			button = ttk.Button(self, text="TIB J LINE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-TIB-JOINT-LINE"))
			...
			button = ttk.Button(self, text="MAD LINE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-MAD-LINE"))
			button.grid(padx=[10,10], sticky="W", column=1, row=14)
			button = ttk.Button(self, text="MAD LINE", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-MAD-LINE"))
			button.grid(padx=[10,10], sticky="W", column=2, row=14)
			

			

			button = ttk.Button(self, text="TIB U3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-TIB-U3"))
			button.grid(padx=[10,10], sticky="W", column=1, row=15)
			button = ttk.Button(self, text="TIB U3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-TIB-U3"))
			button.grid(padx=[10,10], sticky="W", column=2, row=15)
			
			button = ttk.Button(self, text="TIB L3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-TIB-L3"))
			button.grid(padx=[10,10], sticky="W", column=1, row=16)
			button = ttk.Button(self, text="TIB L3", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-TIB-L3"))
