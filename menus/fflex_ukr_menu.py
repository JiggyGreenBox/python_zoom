...
class FFLEX_UKR_Menu(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		if platform == "darwin":
			...
			button = ttk.Button(self, text="FEM TOP", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-TOP"))
			button.grid(padx=[10,10], column=1, row=5)
			button = ttk.Button(self, text="FEM TOP", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-TOP"))
			button.grid(padx=[10,10], column=2, row=5)


			button = ttk.Button(self, text="FEM BOT", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-FEM-BOT"))
			button.grid(padx=[10,10], column=1, row=6)
			button = ttk.Button(self, text="FEM BOT", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-FEM-BOT"))
			button.grid(padx=[10,10], column=2, row=6)

			button = ttk.Button(self, text="PEG TOP", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-PEG-TOP"))
			button.grid(padx=[10,10], column=1, row=7)
			button = ttk.Button(self, text="PEG TOP", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-PEG-TOP"))
			button.grid(padx=[10,10], column=2, row=7)

			button = ttk.Button(self, text="PEG BOT", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-PEG-BOT"))
			button.grid(padx=[10,10], column=1, row=8)
			button = ttk.Button(self, text="PEG BOT", width=b_width, command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-PEG-BOT"))
