...
class EADT_Menu(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		if platform == "darwin":
			...
			button = ttk.Button(self, text="EADT P1", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-EADT-P1"))
			button.grid(padx=[10,10], column=1, row=5)

			button = ttk.Button(self, text="EADT P1", width=b_width,  command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-EADT-P1"))
			...
			button = ttk.Button(self, text="EADT P1", command=lambda: controller.menu_btn_click(self.obj_name, "DEL-RIGHT-EADT-P1"))
			button.grid(padx=[10,10], column=1, row=5)

			button = ttk.Button(self, text="EADT P1", command=lambda: controller.menu_btn_click(self.obj_name, "DEL-LEFT-EADT-P1"))
			button.grid(padx=[10,10], column=2, row=5)
