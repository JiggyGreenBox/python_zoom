...
class UNI_FEM_VAL():
	...
	def draw(self):
		...
		for side in ["LEFT","RIGHT"]:
			...
			# FEM JOINT LINE
			if fem_line_p1 != None:
				self.draw_tools.create_mypoint(fem_line_p1, "orange", [self.tag,side,"FEM_JOINT_LINE","P1"])

			if fem_line_p2 != None:
				self.draw_tools.create_mypoint(fem_line_p2, "orange", [self.tag,side,"FEM_JOINT_LINE","P2"])
