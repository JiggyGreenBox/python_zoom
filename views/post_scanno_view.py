...
class POST_SCANNO_View(tk.Frame):
	...
	def update_dict(self, master_dict):
		...
		if self.master_dict["IMAGES"]["POST-SCANNO"] != None:

			# self.med_image = self.master_dict["IMAGES"]["PRE-SCANNO"]
			self.med_image = self.controller.working_dir + "/" + self.master_dict["IMAGES"]["POST-SCANNO"]
	...
	def open_image_loc(self):
		...
		if isinstance(image, str) and image != "":
			...
			self.master_dict["IMAGES"]["POST-SCANNO"] = rel_path
