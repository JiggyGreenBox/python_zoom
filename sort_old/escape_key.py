...
class MainWindow(ttk.Frame):
	...
	def __init__(self, mainframe, path):
		...
		self.master.bind('<Delete>', lambda event: self.master.after_idle(self.key_funct, event))
	...
	def key_funct(self, event):
		...
		for item in self.master_dict["MAIN"]["PRE-OP"]["RIGHT"]:
			print('item: {}'.format(item))


		print("\n\n\n")
		for item in reversed(self.master_dict["MAIN"]["PRE-OP"]["RIGHT"]):
			print('item: {}'.format(item))
