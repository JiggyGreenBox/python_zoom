...
class CanvasImage:
	...
	def hover(self, event):
		...
		P2 = self.getRealCoords(event)

		# x = event.x  # get coordinates of the event on the canvas
		# y = event.y
		...
		if self.getHover() == True:
			...
			self.create_myline(P, P2, "hover_line")
	...
	def getPoint(self):
		# return self.getScaledCoords(self.hover)		 
		return self.hover

	def setHover(self, hoverBool):
		if hoverBool == False:
			self.canvas.delete("hover_line")
			self.setPoint(None)
